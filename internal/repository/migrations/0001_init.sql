...
CREATE TABLE IF NOT EXISTS withdrawals(username TEXT, order_number TEXT, withdrawn INTEGER, processed_at TIMESTAMP);
CREATE INDEX IF NOT EXISTS withdrawals_idx ON withdrawals USING BTREE (username, order_number, withdrawn, processed_at);
COMMIT;
